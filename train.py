...
from utils.metrics import calculate_ssim_per_channel, calculate_pearson_corr, ChannelWeightedFocalLoss
...
def train(net=None):
    ...
    weights = torch.tensor([1.0, 2.0, 1.0])  # Set the weights for each channel.
...
def get_args():
    ...
    parser.add_argument('-vp', '--val_path', dest='val_path', type=str,
                        default=r'F:\2023_4_11_data_organization\1024_patches\bci_debug\val')
